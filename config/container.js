...
ShindigConfig = exports.ShindigConfig = {
...
//         '/public.cer': 'CertServlet'
    ...
    'base_path': fs.realpathSync(__dirname + '/..') + '/',
    'features_path': {
//         fs.realpathSync(__dirname + '/../../features/src/main/javascript/features') + '/',
//         fs.realpathSync(__dirname + '/../../extras/src/main/javascript/features-extras') + '/',
    },
    'container_path': fs.realpathSync(__dirname + '/../../config') + '/',
    'javascript_path': fs.realpathSync(__dirname + '/../../content') + '/',
    'resources_path': fs.realpathSync(__dirname + '/../external/resources') + '/',

    // The OAuth SSL certificates to use, and the pass phrase for the private key
    'private_key_file': fs.realpathSync(__dirname + '/../certs') + '/private.key',
    'public_key_file': fs.realpathSync(__dirname + '/../certs') + '/public.crt',
    ...
    'jsondb_path': fs.realpathSync(__dirname + '/../../content/sampledata') + '/canonicaldb.json',
    ...
    'service_input_converter': {
        'people': {'class': 'InputPeopleConverter', 'targetField': false},
        'activities': {'class': 'InputActivitiesConverter', 'targetField': 'activity'},
        'appdata': {'class': 'InputAppDataConverter', 'targetField': 'data'},
        'messages': {'class': 'InputMessagesConverter', 'targetField': 'entity'},
        'cache' : {'class': 'InputInvalidateConverter', 'targetField': null},
        'albums': {'class': 'InputAlbumsConverter', 'targetField': 'album'},
        'mediaitems': {'class': 'InputMediaItemsConverter', 'targetField': 'mediaItem'},
    },
