/*
	MD5
	Copyright (C) 2007 MITSUNARI Shigeo at Hash Labs, Inc.
	license:new BSD license
	how to use
	HashLabs.MD5.calc(<ascii string>);
	HashLabs.MD5.calc(<unicode(UTF16) string>, HashLabs.MD5.BY_UTF16);

	ex. HashLabs.MD5.calc("abc") == "900150983cd24fb0d6963f7d28e17f72";
*/
...
new function() {
	  Hash.MD5.calc = navigator.userAgent.match(/Firefox/) ? HashLabs.MD5.calc_Fx : HashLabs.MD5.calc_std;
};
